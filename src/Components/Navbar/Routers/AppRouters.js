...
const Commissions = lazy(() =>
  import('../../../Pages/Commissions/commissions'),
);

const Contact = lazy(() => import('../../../Pages/Contact/contact'));
const Class = lazy(() => import('../../../Pages/Classes/Classes'));
const Testimonial = lazy(() =>
  import('../../../Pages/Testimonial/testimonial'),
);
...
const WildLife = lazy(() =>
  import('../../../Pages/Paintings/WildLife/wild-life'),
);
...
const Portraits = lazy(() =>
  import('../../../Pages/Paintings/Portraits/portraits'),
);
...
const AppRouters = () => {
  // const history = useRouterHistory(history)({
  //   basename: '/basename',
  // });
